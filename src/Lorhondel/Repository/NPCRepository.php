...
use Lorhondel\Http;
use Lorhondel\Parts\NPC\NPC;
use Lorhondel\Parts\Part;
use React\Promise\ExtendedPromiseInterface;

/**
 * Contains all NPCs in Lorhondel.
 *
 * @see \Lorhondel\Parts\NPC\NPC
 *
 * @method NPC|null get(string $discrim, $key)  Gets an item from the collection.
 * @method NPC|null first()                     Returns the first element of the collection.
 * @method NPC|null pull($key, $default = null) Pulls an item from the repository, removing and returning the item.
 * @method NPC|null find(callable $callback)    Runs a filter callback over the repository.
 */
