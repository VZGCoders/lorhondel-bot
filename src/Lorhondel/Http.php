...
class Http
{
    ...
    /**
     * Current Lorhondel HTTP API version.
     *
     * @var string
     */
    ...
    /**
     * Lorhondel API base URL.
     *
     * @var string
     */
    public const BASE_URL = 'https://lorhondel.valzargaming.com/api/v'.self::HTTP_API_VERSION;
        ...
        switch ($response->getStatusCode()) {
            ...
            case 500:
                if (strpos(strtolower((string) $response->getBody()), 'longer than 2000 characters') !== false ||
                    ...
                    // Response was longer than 2000 characters and was blocked by Lorhondel.
    ...
    {
        return 'LorhondelBot (https://github.com/VZGCoders/lorhondel-bot, '.self::VERSION.')';
    }
}